...
<div class="sub-content-container">
	<div class="w90 center">
		<table class="table table table-striped table-bordered  table-condensed RECORD tablesorter canvasTable advancedTable" id="QuestionTable" model="Question">
			<thead>
				<tr>
					<th class="w50 text-center"><a>Content</a></th>
					<th class="w45 text-center"><a>Domain Type</a></th>
			...
			<tbody>
				<tr>
					...
					<td><span data-field='Domain.name'></span></td>
					<td class="actions">
						<div class="btn-group">
