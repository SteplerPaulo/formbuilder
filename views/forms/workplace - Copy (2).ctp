...
<div class="sub-content-container">
	<div class="w90 center">
		<div class="well">
			...
			<? foreach($curr_data['FormDomain'] as $domain):?>
				<dl class="well"> 
					<dt>
						<? echo $domain['name']; ?>
						<span class="pull-right">
							<a action="../domains/edit/" class="fb-workplace-edit"  object-id="<? echo $domain['id'];?>"><i class="icon-edit"> Edit</i></a> |
					...
					<? foreach($curr_data['DomainQuestion'][''.$domain['name'].''] as $question):?>						
							<dd>
								<? echo $question['name']; ?>
								<span class="pull-right">
									<a action="../questions/edit" class="fb-workplace-edit" object-id="<? echo $question['id'];?>"><i class="icon-edit"> Edit</i></a> |
									<a class="fb-workplace-delete"><i class="icon-remove-circle"> Delete</i></a> |
									<a action="../question/create" class="" object-id="<? echo $question['id'];?>"><i class="icon-plus-sign"> Add Option</i></a> 
								</span>						
								<dl class="well">
									<? foreach($question['QuestionOption'] as $option):?>
									
									<dd>	
										<input type="<? echo $question['OptionType']['name'];?>" value="<? echo $option['Option']['value']; ?>">
