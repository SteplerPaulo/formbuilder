...
<div class="row-fluid">
<div class="evaluatorTypes form span6 offset3">

<?php echo $this->Form->create('EvaluatorType',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		<legend><?php __('Edit Evaluator Type'); ?></legend>
