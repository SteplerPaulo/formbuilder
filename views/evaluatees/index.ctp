				...
				<div class="row-fluid">
					<div class="span4 module">
						<div class="module-wrap">
							<div class="module-name evaluatees">
									 <?php echo $this->Html->link( 'Evaluatees',
															'javascript:void()'
														);  ?>								
							</div>
						</div>
...
<div class="sub-content-container">
	<div class="w90 center">
		<table class="table table table-striped table-bordered  table-condensed RECORD tablesorter canvasTable" id="EvaluateeTable" model="Evaluatee">
			<thead>
				<tr>
			...
			<tbody>
				<tr>
					...
					<td><span data-field='Evaluatee.alias'></span></td>
					<td><span data-field='Evaluatee.description'></span></td>
					<td class="actions">
						<div class="btn-group">
...
<?php echo $this->Form->create('Evaluatee',array('name'=>'modalForm','action'=>'add','class'=>'form-horizontal', 'model'=> 'evaluatees', 'canvas'=>'#EvaluateeCanvasForm',
...
<div id="intent-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="intent-label" aria-hidden="true">
	<div class="modal-header">
		<h3 id="intent-label"><span class="intent-text">Create </span><span class="intent-object">Evaluatee</span></h3>
	</div>
	<div class="modal-body">
		<div class="row-fluid">
			<div class="evaluatees form span12">
...
<!-- CANVASFORM -->
<?php echo $this->Form->create('Evaluatee',array('action'=>'index',
															'class'=>'canvasForm',
															'id'=>'EvaluateeCanvasForm',
															'model'=> 'Evaluatee',
															'canvas'=>'#EvaluateeTable'
														)
											);?>
<?php echo $this->Form->end();?>
