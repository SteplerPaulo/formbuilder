				...
				<div class="row-fluid">
					...
					<div class="btn-group span3">
					  ...
					  <ul class="dropdown-menu">
						<!-- dropdown menu links -->
								<li><?php echo $this->Html->link(__('Key Headers', true), array('controller' => 'key_headers', 'action' => 'index')); ?> </li>
					  </ul>
					</div>
				</div>
			</div>
...
<div class="row-fluid">
<div class="keys form span6 offset3">

<?php echo $this->Form->create('Key',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		<legend><?php __('Add Key'); ?></legend>
		<?php echo $this->Form->input('key_header_id',array('placeholder'=>'','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
