				...
				<div class="row-fluid">
					<div class="span4 module">
						<div class="module-wrap">
							<div class="module-name schoolYears">
									 <?php echo $this->Html->link( 'School Years',
															'javascript:void()'
														);  ?>								
							</div>
						</div>
...
<div class="sub-content-container">
	<div class="row-fluid">
		<div class="w90 center">
				<table class="table table table-striped table-bordered  table-condensed RECORD tablesorter canvasTable" id="SchoolYearTable" model="SchoolYear">
			<thead>
				<tr>
																											<th class="w10 text-center"><a >Name</a></th>
																						<th class="w10 text-center"><a >Is Default</a></th>
																<th class="actions w5"><a >Actions</a></th>
				</tr>
			</thead>
			<tbody>
				<tr>
		<td><span data-field='SchoolYear.name'></span></td>
		<td><span data-field='SchoolYear.is_default'></span></td>
		<td class="actions">
					<div class="btn-group">
...
<?php echo $this->Form->create('SchoolYear',array('name'=>'modalForm','action'=>'add','class'=>'form-horizontal', 'model'=> 'schoolYears', 'canvas'=>'#SchoolYearCanvasForm',
...
<div id="intent-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="intent-label" aria-hidden="true">
  <div class="modal-header">
     <h3 id="intent-label"><span class="intent-text">Create </span><span class="intent-object">School Year</span></h3>
  </div>
  <div class="modal-body">
  

<div class="row-fluid">
<div class="schoolYears form span12">
		...
		<?php echo $this->Form->input('is_default',array('placeholder'=>'Is Default','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
</div>
</div>
...
<!-- CANVASFORM -->
<?php echo $this->Form->create('SchoolYear',array('action'=>'index',
															'class'=>'canvasForm',
															'id'=>'SchoolYearCanvasForm',
															'model'=> 'SchoolYear',
															'canvas'=>'#SchoolYearTable'
														)
											);?>
<?php echo $this->Form->end();?>
