...
<div class="row-fluid">
<div class="quizzes form span6 offset3">

<?php echo $this->Form->create('Quiz',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		<legend><?php __('Add Quiz'); ?></legend>
		<?php echo $this->Form->input('form_id',array('placeholder'=>'','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
		<?php echo $this->Form->input('key_id',array('placeholder'=>'','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
		<?php echo $this->Form->input('evaluatee',array('placeholder'=>'','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
		<?php echo $this->Form->input('evaluator',array('placeholder'=>'','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
	</fieldset>
