				...
				<div class="row-fluid">
					<div class="span4 module">
						<div class="module-wrap">
							<div class="module-name educLevels">
									 <?php echo $this->Html->link( 'Educ Levels',
															'javascript:void()'
														);  ?>								
							</div>
						</div>
...
<div class="sub-content-container">
	<div class="row-fluid">
		<div class="w90 center">
				<table class="table table table-striped table-bordered  table-condensed RECORD tablesorter canvasTable" id="EducLevelTable" model="EducLevel">
			<thead>
				<tr>
			...
			<tbody>
				<tr>
		<td><span data-field='EducLevel.name'></span></td>
		<td><span data-field='EducLevel.alias'></span></td>
		<td class="actions">
					<div class="btn-group">
...
<?php echo $this->Form->create('EducLevel',array('name'=>'modalForm','action'=>'add','class'=>'form-horizontal', 'model'=> 'educLevels', 'canvas'=>'#EducLevelCanvasForm',
...
<div id="intent-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="intent-label" aria-hidden="true">
  <div class="modal-header">
     <h3 id="intent-label"><span class="intent-text">Create </span><span class="intent-object">Educ Level</span></h3>
  </div>
  <div class="modal-body">
  

<div class="row-fluid">
<div class="educLevels form span12">
...
<!-- CANVASFORM -->
<?php echo $this->Form->create('EducLevel',array('action'=>'index',
															'class'=>'canvasForm',
															'id'=>'EducLevelCanvasForm',
															'model'=> 'EducLevel',
															'canvas'=>'#EducLevelTable'
														)
											);?>
<?php echo $this->Form->end();?>
