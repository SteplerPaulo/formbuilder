...
<div class="sub-content-container">
	<div class="w90 center">
		<?php echo $this->Form->create('ElectionReport',array('id'=>'ElectionReportForm','action'=>'add'));?>
		<div class="well"><br/>
			<dl class="well">
				<?php echo '<b><center>'.$form['Form']['title']. '<center/><center>'.$form['Form']['description'].'<center/></b>'; ?>
				<?php echo $this->Form->input('ElectionReport.form_id',array('type'=>'hidden','value'=>$form['Form']['id'])); ?>	
			...
			<dl class="well"> 
				...
				<dd>
					...
					<?php if($question_data['OptionType']['name'] == "textarea"){; ?>
						<dl class="textarea">
							<dd>
							<?php echo $this->Form->input('ElectionReportDetail.'. $index.'.answer',array('type'=>'textarea','class'=>'center w100','placeholder'=>'Fill out this area...','label'=>false)); ?>
							<?php echo $this->Form->input('ElectionReportDetail.'. $index.'.question_id',array('type'=>'hidden','value'=>$question_data['id'],'label'=>false)); ?>
							<?php echo $this->Form->input('ElectionReportDetail.'. $index++ .'.option_type',array('type'=>'hidden','value'=>'textarea','label'=>false)); ?>
							</dd>
						</dl><br/>
					<?php }else if($question_data['OptionType']['name'] == "checkbox"){; ?>
						<dl class="options well">
							...
							<dd>
								<input type="checkbox" name="data[ElectionReportDetail][<?php echo $index;?>][option_id]" value="<?php echo $option['Option']['id']; ?>"></input>
								<?php echo $option['Option']['text']; ?>
								<?php echo $this->Form->input('ElectionReportDetail.'. $index .'.question_id',array('type'=>'hidden','value'=>$question_data['id'],'label'=>false)); ?>
								<?php echo $this->Form->input('ElectionReportDetail.'. $index++ .'.option_type',array('type'=>'hidden','value'=>'checkbox','label'=>false)); ?>
							</dd>
							<?php endforeach;?>
						</dl>
					...
					<?php }else if($question_data['OptionType']['name'] == "radio"){; ?>
						...
						<dl class="options well">
							<?php foreach($question_data['QuestionOption'] as $option):?>
							<dd>
								<input type="radio" name="data[ElectionReportDetail][<?php echo $index;?>][option_id]" value="<?php echo $option['Option']['id']; ?>"></input>
								<?php echo $option['Option']['text']; ?>
							</dd>
							<?php endforeach;?>
							<?php echo $this->Form->input('ElectionReportDetail.'. $index .'.question_id',array('type'=>'hidden','value'=>$question_data['id'],'label'=>false)); ?>
							<?php echo $this->Form->input('ElectionReportDetail.'. $index++ .'.option_type',array('type'=>'hidden','value'=>'radio','label'=>false)); ?>
						</dl>
					<?php }; ?>
				</dd>
				<?php endforeach;?>
...
<?php 
	echo $this->Html->script(array('formbuilder/formelectionreport'),array('inline'=>false));
?>